...
Public Class Crystalallassets
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SCHOOLPAY.Crystalallassets.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalallassets
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalallassets = New Crystalallassets()
        rpt.Site = Me.Site
        Return rpt
    End Function
