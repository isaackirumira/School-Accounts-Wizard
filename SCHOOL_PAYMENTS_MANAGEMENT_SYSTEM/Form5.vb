...
Public Class Form5
    ...
    Public Sub updatebalance()
        ...
        Try
            ...
            SelectCommand = New MySqlCommand("update  school_payments.meal_ream set balance= '" & actual & "'  where class='" & txt_class.Text & "' and term='" & txt_term.Text & "' and year='" & txt_year.Text & "' and name='" + txt_name.Text + "' and payment='" + txt_payment.Text + "' ", mycon)
    ...
    Public Sub getamountpaidbystudent()
        Try
            Dim myConnection As String = "datasource=localhost;port=3306;username=root;"
            Dim mycon As MySqlConnection = New MySqlConnection(myConnection)
            Dim SelectCommand As MySqlCommand = New MySqlCommand("Select sum(amount) from school_payments.pay where payment='" + txt_payment.Text + "' and class='" + txt_class.Text + "' and term='" + txt_term.Text + "' and year='" + txt_year.Text + "' and name='" + txt_name.Text + "';", mycon)
            Dim myReader As MySqlDataReader
